...
<head>
    ...
    <link href="assets/admin/css/lib/data-table/buttons.bootstrap.min.css" rel="stylesheet" />
...
<body>
                                                        ...
                                                        foreach($data as $r){
                                                            ...
                                                            echo"
                                                                <tr>
                                                                    ...
                                                                    <td>{$r['branch']}</td>
                                                                    <td>
                                                                        <a href='?_admin=update.member&token={$token}&id={$id}' class='text-danger'>View</a>
                                                                    </td>
                                                                </tr>
                                                            ";
                                                        }
    ...
    <script src="assets/admin/js/lib/data-table/buttons.flash.min.js"></script>
